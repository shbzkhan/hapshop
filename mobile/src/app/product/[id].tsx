...
import BottomBox from '@/modules/product/components/BottomBox'
import DeliveryDetails from '@/modules/product/components/DeliveryDetails'
import ProductSlider from '@/modules/product/components/ProductSlider'
import SelectVariant from '@/modules/product/components/SelectVariant'
